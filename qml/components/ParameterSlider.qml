...
Item {
    ...
    Rectangle {
        ...
        Rectangle { x:2+(parent.width-12-4)*root.valueToNorm(root.value)-5;anchors.verticalCenter:parent.verticalCenter;width:22;height:18;radius:9;color:root.accentColor;opacity:root.activeFocus?.17:pointer.containsMouse?.11:.06;z:-1 }
        Rectangle {
    ...
    Rectangle {
        ...
        color:"#06090C";border.width:1;border.color:"#1B242B"
        Row {
            ...
            Text{text:root.unit;color:Theme.textDim;font.family:Theme.monoFamily;font.pixelSize:7;anchors.baseline:parent.children[0].baseline}
        }
    }
